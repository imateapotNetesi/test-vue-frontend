...
const routes = [
			...
			children: [
				{
					path: "main",
					name: "main",
					component: () => import("./views/app/sample/main")
				},
				{
					path: "password",
					name: "password",
					component: () => import("./views/app/sample/password")
				},
				{
					path: "sample",
					name: "sample",
				...
				},
				{
					path: "sample.v1",
					name: "sample.v1",
					component: () => import("./views/app/sample/sample.v1")
				},
				{
					path: "sample.v2",
					name: "sample.v2",
					component: () => import("./views/app/sample/sample.v2")
				},
				{
					path: "sample.v3",
					name: "sample.v3",
					component: () => import("./views/app/sample/sample.v3")
				}
  ...
  {
    path: "/vertical-sidebar-two",
    component: () => import("./containers/layouts/verticalSidebarTwo")
  },
  {
    path: "*",
    component: () => import("./views/app/pages/notFound")
